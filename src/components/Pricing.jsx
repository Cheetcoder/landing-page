      ...
      <Container>
        <div className="md:text-center">
          <p className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Strict schedule,</span>
            </span>{' '}
            for everyone.
          </p>
          <p className="mt-4 text-lg text-slate-400">
            ...
            If you want a part time program we recommend https://interviewcamp.io/ , https://www.outco.io/ or  https://learn.interviewkickstart.com/ 
          </p>
        </div>
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          ...
          <Plan
            ...
            name="Full Time"
            price="FREE"
            description="You are signing up for a full time cohort, 7 days a week, 12 hours a day."
            href="https://docs.google.com/forms/d/13IUKfB9sJkypCWi-54Zj-htNBGBM71CVxjtfyxySSDk"
            features={[
              '5-15 Problems a Day',
